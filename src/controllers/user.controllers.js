...
// giving options to update the profile and account / rember whenever you want to update files and all then make new controller that will go for you
...
// how to update the files -> basicly need some midleware -> multer and ..
