...
import { Home, Users, History, ThumbsUp, PlaySquare, LayoutDashboard } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2">
        ...
        <SidebarItem icon={Users} label="Subscriptions" to="/subscriptions" active={location.pathname === '/subscriptions'} />
